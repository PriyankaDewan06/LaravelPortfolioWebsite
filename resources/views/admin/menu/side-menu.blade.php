...
{{--                custom menus starts --}}
                <li class="nav-small-cap">
                    <i class="mdi mdi-dots-horizontal"></i>
                    <span class="hide-menu">Site Menus</span>
                </li>
{{--                <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{ route('manage-contact') }}" aria-expanded="false"><i class="mdi mdi-file-image"></i><span class="hide-menu">My-Image</span></a></li>--}}
                <li class="sidebar-item">
                    <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                        <i class="mdi mdi-code-braces"></i>
                        <span class="hide-menu">Laravel Raw</span>
                        <span class="badge badge-pill badge-info ml-auto m-r-15">4</span>
                    </a>
                    <ul aria-expanded="false" class="collapse  first-level">
                        <li class="sidebar-item">
                            <a href="{{route('manage-contact')}}" class="sidebar-link">
                                <i class="mdi mdi-adjust"></i>
                                <span class="hide-menu"> Contact </span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a href="{{route('mng-img')}}" class="sidebar-link">
                                <i class="mdi mdi-adjust"></i>
                                <span class="hide-menu"> My Image </span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a href="{{route('mng-project')}}" class="sidebar-link">
                                <i class="mdi mdi-adjust"></i>
                                <span class="hide-menu"> Recent Projects </span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a href="{{route('mng-cms')}}" class="sidebar-link">
                                <i class="mdi mdi-adjust"></i>
                                <span class="hide-menu"> CMS Details </span>
                            </a>
                        </li>
                    </ul>
                </li>
{{--                custom menus ends--}}
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="https://www.wrappixel.com/demos/admin-templates/nice-admin/docs/documentation.html" aria-expanded="false">
